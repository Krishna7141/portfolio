...
const ContactSection = () => {
  return (
    <div id='contact' className='max-w-[1280px] min-h-[700px] mt-10 mb-10 mx-auto'>
        ...
        <form className='w-[90%] md:w-1/2 flex flex-col gap-6 items-center justify-center mx-auto' action='https://formsubmit.co/krishnavamsich2000@gmail.com' target='_blank' method='POST'>
